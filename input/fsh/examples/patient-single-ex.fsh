...
* extension[indigenousPeople].url = "https://doh.gov.ph/ph-core/fhir/StructureDefinition/indigenous-people"
* extension[indigenousPeople].valueBoolean = true
* extension[indigenousGroup].url = "https://doh.gov.ph/ph-core/fhir/StructureDefinition/indigenous-group"
* extension[indigenousGroup].valueCodeableConcept = https://doh.gov.ph/ph-core/fhir/CodeSystem/indigenous-groups#Ilongots "Ilongots" 
* extension[race].url = "https://doh.gov.ph/ph-core/fhir/StructureDefinition/race"
* extension[race].valueCodeableConcept = http://terminology.hl7.org/CodeSystem/v3-Race#2036-2 "Filipino"
* identifier.system = "https://doh.gov.ph/ph-core/fhir/NamingSystem/philhealth-id-ns"
...
* address.extension.url = "https://doh.gov.ph/ph-core/fhir/StructureDefinition/barangay"
* address.extension.valueCoding = PSGC#1380100001 "Barangay 1"

* address.extension.url = "https://doh.gov.ph/ph-core/fhir/StructureDefinition/city-municipality"
...
* address.extension[+].url = "https://doh.gov.ph/ph-core/fhir/StructureDefinition/province"
