...
* address.country = "PH"
* address.extension.url = "https://fhir.doh.gov.ph/fhir/phcore/StructureDefinition/barangay"
* address.extension.valueCoding = $PSGC#013307025 "Paringao"
* address.extension[+].url = "https://fhir.doh.gov.ph/fhir/phcore/StructureDefinition/city-municipality"
* address.extension[=].valueCoding = $PSGC#013307000 "Bauang"
* address.extension[+].url = "https://fhir.doh.gov.ph/fhir/phcore/StructureDefinition/province"
* address.extension[=].valueCoding = $PSGC#013300000 "La Union"
* address.extension[+].url = "https://fhir.doh.gov.ph/fhir/phcore/StructureDefinition/region"
