...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/ph-core-capability-statement"
      },
      "name" : "PH Core CapabilityStatement",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "CapabilityStatement/ExamplePHCoreCapabilityStatement"
      },
      "name" : "PH Core Server CapabilityStatement",
