...
* Examples for this Extension: [Bundle/transaction-example](Bundle-transaction-example.md), [Philippine General Hospital](Location-location-single-example.md), [Department of Health - Sattelite Office](Organization-organization-single-example.md), [Patient/patient-single-example](Patient-patient-single-example.md)... Show 2 more, [Practitioner/practitioner-single-example](Practitioner-practitioner-single-example.md) and [RelatedPerson/relatedperson-single-example](RelatedPerson-relatedperson-single-example.md)
...
```json
{
  ...
  "status" : "draft",
  "experimental" : true,
  "date" : "2026-06-10T01:16:31+00:00",
